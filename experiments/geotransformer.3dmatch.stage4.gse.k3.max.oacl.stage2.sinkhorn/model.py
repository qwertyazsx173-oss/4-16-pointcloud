...
from geotransformer.modules.geotransformer import (
    ...
    CorrespondenceReliability,
    GeometryGuidedPoseRefinement,
    HighOrderGraphReasoning,
)
...
class GeoTransformer(nn.Module):
    def __init__(self, cfg):
        ...
        self.hogr = HighOrderGraphReasoning(
            hidden_dim=cfg.hogr.hidden_dim,
            num_layers=cfg.hogr.num_layers,
            topk=cfg.hogr.topk,
            graph_k=cfg.hogr.graph_k,
            compatibility_sigma=cfg.hogr.compatibility_sigma,
        )

        self.crm = CorrespondenceReliability(
            hidden_dim=cfg.crm.hidden_dim,
            output_dim=cfg.crm.output_dim,
        )

        self.pose_refiner = GeometryGuidedPoseRefinement(
            num_steps=cfg.gpr.num_steps,
        )
    ...
    def forward(self, data_dict):
        ...
        output_dict['node_corr_scores_before_hogr'] = node_corr_scores

        ref_node_corr_indices, src_node_corr_indices, node_corr_scores = self.hogr(
        ...
        output_dict['ref_node_corr_indices_after_hogr'] = ref_node_corr_indices
        output_dict['src_node_corr_indices_after_hogr'] = src_node_corr_indices
        output_dict['node_corr_scores_after_hogr'] = node_corr_scores
        ...
        node_corr_reliability = self.crm(
        ...
        output_dict['node_corr_reliability'] = node_corr_reliability
        node_corr_scores = node_corr_scores * node_corr_reliability
        ...
        with torch.no_grad():
            ...
            ref_corr_points, src_corr_points, corr_scores, estimated_transform_init = self.fine_matching(
                ref_node_corr_knn_points,
                src_node_corr_knn_points,
                ref_node_corr_knn_masks,
                src_node_corr_knn_masks,
            ...
            estimated_transform = self.pose_refiner(
                ref_corr_points,
                src_corr_points,
                corr_scores,
                estimated_transform_init,
            )

            output_dict['ref_corr_points'] = ref_corr_points
            output_dict['src_corr_points'] = src_corr_points
            output_dict['corr_scores'] = corr_scores
            output_dict['estimated_transform_init'] = estimated_transform_init
